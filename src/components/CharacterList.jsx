    ...
    <div className="space-y-4">
      ...
      <div className="pb-6">
        <Button 
          ...
          className="w-full bg-black hover:bg-gray-800 text-white dark:bg-zinc-800 dark:hover:bg-zinc-700 dark:text-zinc-300 dark:hover:text-zinc-100 transition-colors duration-200"
        >
          Add Character
        </Button>
      </div>
